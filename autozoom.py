...
exec(open('/content/3d-ken-burns/common.py', 'r').read())

exec(open('/content/3d-ken-burns/models/disparity-estimation.py', 'r').read())
exec(open('/content/3d-ken-burns/models/disparity-adjustment.py', 'r').read())
exec(open('/content/3d-ken-burns/models/disparity-refinement.py', 'r').read())
exec(open('/content/3d-ken-burns/models/pointcloud-inpainting.py', 'r').read())
